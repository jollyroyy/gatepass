// The five signatures a printed gate pass carries, defined once.
//
// Row 1 is the approval chain, signed BEFORE the material moves:
//   Issuing HOD → Security HOD → Finance HOD
// Row 2 is what happens AT the gate, signed as it moves:
//   Security Verification → Receiver Signature
//
// The same five appear on every category — RGP Out, RGP In and NRGP Out. The
