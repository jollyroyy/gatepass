...
export const FUNCTIONAL_ROLES: FunctionalRole[] = [
  ...
  },
  {
    ...
    kind: 'Gate pass approval office',
    purpose: 'Signs second, once the Security Head has approved.',
    can: [
  ...
  },
  {
    ...
    kind: 'Gate pass approval office',
    purpose: 'Signs third, costing the movement before it reaches the CEO.',
    can: ['See and decide a pass only after the COO has approved it'],
    grantedBy: 'approval_ladder',
  },
  {
    key: 'ceo',
    ...
    kind: 'Gate pass approval office',
    purpose: 'Signs last. Once this office approves, the pass is released to the gate.',
    can: [
