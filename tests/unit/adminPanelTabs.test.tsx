...
describe('AdminPanel tabs', () => {
  it('offers exactly Departments, Users, Blacklist and Whitelist Requests, in that order', () => {
    render(<AdminPanel />);
    const labels = screen
      .getAllByRole('button')
      .map((b) => b.textContent?.trim());
    expect(labels).toEqual(['Departments', 'Users', 'Blacklist', 'Whitelist Requests']);
  });
